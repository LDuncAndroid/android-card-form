...
public class CardTypeTest {
    ...
    static {
        ...
        SAMPLE_CARDS.put("560000000003", CardType.MAESTRO);
        SAMPLE_CARDS.put("5600000000000000002", CardType.MAESTRO);
        SAMPLE_CARDS.put("570000000002", CardType.MAESTRO);
        SAMPLE_CARDS.put("5700000000000000018", CardType.MAESTRO);
        SAMPLE_CARDS.put("580000000001", CardType.MAESTRO);
